...
import { answerTextChangeHandler,setError,answerFileChangeHandler,answerFileDeleteHandler } from "../../../../Redux/Actions";
...
class QuestionsList extends Component {
    ...
    answerFileUpload = (e,index) => {
        if (e.target.files[0]) {
            ...
            this.props.answerFileChangeHandler(
                e,
                file,
                index
            );
                ...
                <li className="text-justify">
                    ...
                    <div className="form-group mt-3">
                        <textarea
                            ...
                            onChange={(e)=>{this.props.answerTextChangeHandler(e,0)}}
                        ></textarea>
                    </div>
                </li>
                <li className="text-justify">
                    ...
                    <div className="form-group mt-3">
                        <textarea
                            ...
                            onChange={(e)=>{this.props.answerTextChangeHandler(e,1)}}
                        ></textarea>
                    </div>
                </li>
                <li className="text-justify">
                    ...
                    <div className="form-group mt-3">
                        <textarea
                            ...
                            onChange={(e)=>{this.props.answerTextChangeHandler(e,2)}}
                        ></textarea>
                    </div>
                </li>
                <li className="text-justify">
                    ...
                    <div className="form-group mt-3">
                        <textarea
                            ...
                            onChange={(e)=>{this.props.answerTextChangeHandler(e,3)}}
                        ></textarea>
                    </div>
                </li>
                <li className="text-justify">
                            ...
                            <div className="d-flex">
                                <div className="file-selected col-12 px-4 py-3 d-flex flex-row">
                                        <div className="del-icon" onClick={
                                            () => this.answerFileDelete(this.props.questions[4].answer,4)
                                        }>
                                    ...
                                    <div className="ml-2">
                                        <p className="mb-0">
                                            <b>{this.props.questions[4].answer.name}</b>
                                        </p>
                                        <small>
                                            Filesize : {this.props.questions[4].answer.size}
                                        </small>
                                    </div>
                                </div>
                            </div>
                ...
                <li className="text-justify">
                    ...
                    <div className="custom-control custom-radio  mt-3">
                        <input
                            ...
                            value="yes"
                            id={"radio1"+5}
                            onChange={(e)=>{this.props.answerTextChangeHandler(e,5)}}
                            checked={this.props.questions[5].answer === "yes" ? true : false}
                        />
                        <label
                    ...
                    <div className="custom-control custom-radio  mb-3">
                        <input
                            ...
                            id={"radio2"+5}
                            onChange={(e)=>{this.props.answerTextChangeHandler(e,5)}}
                            checked={this.props.questions[5].answer === "no" ? true : false}
                        />
                        <label
                            className="custom-control-label"
                            htmlFor={"radio2"+5}
                ...
                <li className="text-justify">
                    ...
                    <div className="custom-control custom-radio  mt-3">
                        <input
                            ...
                            value="yes"
                            id={"radio1"+6}
                            onChange={(e)=>{this.props.answerTextChangeHandler(e,6)}}
                            checked={this.props.questions[6].answer === "yes" ? true : false}
                        />
                        <label
                            className="custom-control-label"
                            htmlFor={"radio1"+6}
                    ...
                    <div className="custom-control custom-radio  mb-3">
                        <input
                            ...
                            id={"radio2"+6}
                            onChange={(e)=>{this.props.answerTextChangeHandler(e,6)}}
                            checked={this.props.questions[6].answer === "no" ? true : false}
                        />
                        <label
                            className="custom-control-label"
                            htmlFor={"radio2"+6}
                    ...
                    <div className="form-group mt-3">
                        {this.props.questions[7].answer ? (
                            ...
                            <div className="d-flex">
                                <div className="file-selected col-12 px-4 py-3 d-flex flex-row">
                                        <div className="del-icon" onClick={
                                            () => this.answerFileDelete(this.props.questions[7].answer,7)
                                        }>
                                            <div className="overlay"></div>
                                            <div className="icon-wrapper">
                                                <img src={TrashIcon} alt="trash icon"/>
                                    ...
                                    <div className="ml-2">
                                        <p className="mb-0">
                                            <b>{this.props.questions[7].answer.name}</b>
                                        </p>
                                        <small>
                                            Filesize : {this.props.questions[7].answer.size}
                                        </small>
                                    </div>
                                </div>
                            </div>
...
export default connect(mapStateToProps,{answerTextChangeHandler,setError,answerFileChangeHandler,answerFileDeleteHandler})(QuestionsList)